...
<body>
	<div class="content">
		...
		<form action="/add/student/registration" method="post">
            @csrf
			<b>Student name</b><br> <input type="text" name="user_name"  placeholder="Student name" required><br><br>
			...
			<br><br>
            <b>Password</b><br> <input type="password" name="password"  placeholder="enter password" required><br><br>
